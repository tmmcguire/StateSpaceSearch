...
public class FifteenPuzzle {
	...
	public static void main(String[] args)
	{
		...
		runSearch(fifo, new HashSet<FState>());
		
		System.out.println("Heuristic search");
		Queue<FState> priority = new PriorityQueue<FState>();
		runSearch(priority, new HashSet<FState>());
	}

	private static void runSearch(Queue<FState> queue, Set<FState> seen)
	{
		Search<FState> search = new Search<FState>(queue, seen, FState.oneOut());
